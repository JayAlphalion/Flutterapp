...
import 'package:alpha_app/Model/responses/GetPreviousClaim.dart';
...
class _ClaimsHomePageState extends State<ClaimsHomePage> {
  ...
  GetPreviousApiResponse? getPreviousClaimData;
  ...
  void _handleGetPreviousClaimResponse() {
    claimDataBloc.previousClaimDataStream.listen((event) {
      ...
      if (event != NetworkConstant.FAILURE) {
        getPreviousClaimData = GetPreviousApiResponse.fromJson(event);
      }
      setState(() {
        isloading = false;
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     ListView.builder(
      itemCount: getPreviousClaimData!.data.length,
