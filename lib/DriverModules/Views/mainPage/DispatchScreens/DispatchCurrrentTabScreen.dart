...
class DispatchCurrentTab extends StatefulWidget {
  // const DispatchCurrentTab({super.key});
  final GetCurrentLoadDispatchResponse? currentLoadDispatchResponse;
  DispatchCurrentTab({this.currentLoadDispatchResponse});
  @override
  State<DispatchCurrentTab> createState() => _DispatchCurrentTabState();
}

class _DispatchCurrentTabState extends State<DispatchCurrentTab> {
