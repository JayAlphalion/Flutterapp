...
class BrokerGroupScreen extends StatefulWidget {
  const BrokerGroupScreen({Key? key}) : super(key: key);

  @override
  State<BrokerGroupScreen> createState() => _BrokerGroupScreenState();
}

class _BrokerGroupScreenState extends State<BrokerGroupScreen> {
  String groupId = '';
