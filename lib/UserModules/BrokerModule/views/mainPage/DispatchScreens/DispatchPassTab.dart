...
import 'package:alpha_app/UserModules/BrokerModule/views/mainPage/DispatchScreens/Load_Details.dart';
...
class _DispatchPastTabState extends State<DispatchPastTab> {
  ...
  Widget build(BuildContext context) {
    return widget.pastDispatchLoadApiResponse == null
        ? Center(
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const LoadDetailsPage()));
                },
                child: Card(
                  child: Padding(
                            ...
                            children: [
                              ...
                              Text(
                                widget.pastDispatchLoadApiResponse!.data[index]
                                        .PUDate +
                                    ' ' +
                                    widget.pastDispatchLoadApiResponse!
                                        .data[index].PUTime,
                                style: TextStyle(
                                    fontSize: 18,
