...
import 'package:alpha_app/UserModules/BrokerModule/views/mainPage/Broker_DashBoard.dart';
...
class BrokerSplashScreen extends StatefulWidget {
  // const SplashScreen({super.key});

  @override
  State<BrokerSplashScreen> createState() => _BrokerSplashScreenState();
}

class _BrokerSplashScreenState extends State<BrokerSplashScreen> {
  ...
  void navigagte() async {
    ...
    if (mounted) {
      Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(
            builder: (context) => BrokerDashboard(index: 0),
          ),
          (Route<dynamic> route) => false);
    }
  }
