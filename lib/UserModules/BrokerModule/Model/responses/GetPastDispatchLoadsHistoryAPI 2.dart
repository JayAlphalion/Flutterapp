class GetPastDispatchLoadApiResponse {
  GetPastDispatchLoadApiResponse({
    required this.data,
  });
  late final List<PastDispatchLoadsData> data;
  
  GetPastDispatchLoadApiResponse.fromJson(Map<String, dynamic> json){
    data = List.from(json['data']).map((e)=>PastDispatchLoadsData.fromJson(e)).toList();
  }
...
class PastDispatchLoadsData {
  PastDispatchLoadsData({
  ...
  PastDispatchLoadsData.fromJson(Map<String, dynamic> json){
    status = json['status'];
